...
RSpec.describe WikisController, type: :controller do
  ...
  describe "GET #new" do
    ...
    it "instantiates @wiki" do
      get :new
      expect(assigns(:wiki)).no_to be_nil
    end
  end
  ...
  describe "GET edit" do
    ...
    it "assigns wiki to be updated @wiki" do
      ...
      expect(wiki_instance.title).to eq my_wiki_title
      expect(wiki_instance.body).to eq my_wiki_body
      expect(wiki_instance.private).to eq my_wiki_private
    end
  end

  describe "POST create" do
    it "increases the number of Wiki by 1" do
      expect{ post :create, params: { title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false } }
    end

    it "assigns the new wiki to @wiki" do
      post :create, params: { title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false }
